    ...
    >
      ...
      >
        <motion.div
          ...
          className={cn("h-full px-6 py-10 sm:px-10 sm:py-16", className)}
        >
          <Noise />
          {children}
        </motion.div>
...
const Noise = () => {
  return (
    <div
      className="absolute inset-0 w-full h-full scale-[1.2] transform opacity-5 pointer-events-none [mask-image:radial-gradient(#fff,transparent,75%)]"
      style={{
